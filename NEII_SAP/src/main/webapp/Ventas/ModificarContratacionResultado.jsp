<%-- 
    Document   : ModificarContratacionResultado
    Created on : 22/04/2019, 05:20:02 PM
...
<%
    ...
    ArrayList lista = (ArrayList) sesion.getAttribute("contModificar");
%>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div class="container"<!-- INICIO DE SECCION PRINCIPAL -->
            <div class="div-interno-centrado">
                <div class="form-centrado">
                    <form class="form-control" method="POST" autocomplete="off" action="../GuardarModContratacion">
                        <table>
                            <tbody>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" value="<%= lista.get(0) %>" id="idContModG" name="idContModG" autocomplete="off" readonly="readonly">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <select id='servContratacionMod' name="servContratacionMod" class='form-control form-control-sm' required="required">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id='clienteContratacionMod' name="clienteContratacionMod" class='form-control form-control-sm' required="required">
                                            <option value='' selected='selected'>Selecciona&nbsp;una&nbsp;opci&oacute;n...</option>
                                            <%
                                                int x = 0;
