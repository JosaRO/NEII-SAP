<%-- 
    Document   : ModificarPromocionResultado
    Created on : 22/04/2019, 06:21:54 PM
        ...
        <div class="container"<!-- INICIO DE SECCION PRINCIPAL -->
            <div class="div-interno-centrado">
                <div class="form-centrado">
                    <form class="form-control" method="POST" autocomplete="off" action="../GuardarModPromocion">
                        <table>
                            <tr>
                                <td>
                                    ID
                                ...
                                <td>
                                    <input type="text" id="idPromoModG" name="idPromoModG" autocomplete="off" readonly="readonly">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <select id='prodPromMod' name="prodPromMod" class='form-control form-control-sm' required="required">
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea id="descPromMod" name="descPromMod" rows="4" cols="50"></textarea> 
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <select id='mesPromMod' name="mesPromMod" class='form-control form-control-sm' required="required">
                                    ...
                                    <select id='anioPromMod' name="anioPromMod" class='form-control form-control-sm' required="required">
