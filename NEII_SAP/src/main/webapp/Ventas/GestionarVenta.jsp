<%-- 
    Document   : GestionarVenta
    Created on : 22/04/2019, 01:20:07 PM
...
<%
    ...
    ArrayList lista = c.consulta("producto.nombre,cliente.nombre,venta_producto.id", "venta_producto,producto,cliente",
            "venta_producto.id is not null AND venta_producto.producto = producto.id AND venta_producto.cliente = cliente.id LIMIT 20", 3);
%>
<!DOCTYPE html>
<html>
    <head>
