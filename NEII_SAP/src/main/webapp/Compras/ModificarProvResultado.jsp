<%-- 
    Document   : ModificarProvResultado
    Created on : 1/03/2019, 08:34:37 PM
...
<%
    ...
    ArrayList lista = (ArrayList) sesion.getAttribute("provMod");
%>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div class="container"<!-- INICIO DE SECCION PRINCIPAL -->
            <div class="div-interno-centrado">
                <div class="form-centrado">
                    <form class="form-control" method="POST" autocomplete="off" action="../GuardarModProv">
                        <table>
                            <tbody>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-control-sm" id="idProvMod" name="idProvMod" value="<%= lista.get(0) %>" readonly="readonly">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-control-sm" id="nombreProvMod" name="nombreProvMod" value="<%= lista.get(1) %>" required="required">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="number" step="any" class="form-control form-control-sm" id="telProvMod" name="telProvMod" value="<%= lista.get(2) %>" required="required">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
