<%-- 
    ...
    Created on : 2/02/2019, 07:54:33 PM
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" class="form-control form-control-sm" id="idEmpDes" name="idEmpDes" required="required">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <center>
                                            <input type="submit" class="btn btn-success" value="Despedir">
                                        </center>
                                    </td>
                                </tr>
                            </tbody>
