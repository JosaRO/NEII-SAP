...
public class Contratar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String direccion = request.getParameter("dirEmp");
        String sueldo = request.getParameter("sueldoEmp");
        String cuenta = request.getParameter("cuentaEmp");
        String pass = request.getParameter("passEmp");
        Conexion c = new Conexion();
        c.insertar("nombre,apellido,area,direccion,sueldo,cuenta,contrasena", "empleado", "'");
    }
