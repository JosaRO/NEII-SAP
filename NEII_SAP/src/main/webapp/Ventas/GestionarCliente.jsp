<%-- 
    ...
    Created on : 22/04/2019, 12:35:30 PM
...
<%
    ...
    ArrayList lista = c.consulta("cliente.nombre,cliente.telefono,cliente.id", "cliente",
            "cliente.id is not null LIMIT 20", 3);
%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body onload="regreso();">
        ...
        <div class="container"><!-- INICIO DE SECCION PRINCIPAL -->
                <form class="form-control" method="POST" autocomplete="off" action="../BuscarCliente">
                    <table style="width: 100%;">
                        <tr>
                            <td>
                                <input class="form-control form-control-sm" type="number" step="any" id="clienteBuscada" name="clienteBuscada" autocomplete="off">
                            </td>
                            <td>
                ...
                <table class="tabla">
                    ...
                    <tr>
                        ...
                        %>
                                    ...
                                    <td>
                                    <center>
                                        <form autocomplete="off" method="POST" action="../ModificarCliente">
                                            <input type="text" id="idClienteMod" name="idClienteMod" value="<%= lista.get(i-1) %>" hidden="true">
