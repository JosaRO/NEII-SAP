<%-- 
    Document   : GestionarPromocion
    Created on : 22/04/2019, 05:33:43 PM
...
<%
    ...
    ArrayList lista = c.consulta("descripcion,vigencia,id", "promociones","id is not null AND estado != 10 LIMIT 20", 3);
%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body onload="regreso();">
        ...
        <div class="container"><!-- INICIO DE SECCION PRINCIPAL -->
                <form class="form-control" method="POST" autocomplete="off" action="../BuscarPromocion">
                    <table style="width: 100%;">
                        <tr>
                            <td>
                                <input class="form-control form-control-sm" type="number" step="any" id="promoBuscada" name="promoBuscada" autocomplete="off">
                            </td>
                            <td>
            ...
            <scroll-container>
                <table class="tabla">
                    <tr>
                        ...
                        <td style="text-align: center;"><b>Vigencia</b></td>
                    ...
                    <tr>
                        ...
                        %>
                                    <td>
                                        <center>
                                            <form autocomplete="off" method="POST" action="../EliminarPromocion">
                                                <input type="text" id="idPromoEli" name="idPromoEli" value="<%= lista.get(i-1) %>" hidden="true">
                                    ...
                                    <td>
                                        <center>
                                            <form autocomplete="off" method="POST" action="../ModificarPromocion">
                                                <input type="text" id="idPromoMod" name="idPromoMod" value="<%= lista.get(i-1) %>" hidden="true">
