...
public class EliminarPromocion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String id = request.getParameter("idPromoEli");
        Conexion c = new Conexion();
        c.actualizar("estado = 10", "promociones", "id = "+id);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(EliminarPromocion.class.getName()).log(Level.SEVERE, null, ex);
