<%-- 
    Document   : BuscarOrden
    Created on : 2/03/2019, 04:57:27 PM
...
<%
    ...
    ArrayList lista = c.consulta("producto.nombre,proveedor.nombre,orden.id", "orden,producto,proveedor",
            "orden.id is not null AND orden.producto = producto.id AND orden.proveedor = proveedor.id", 3);
%>
<!DOCTYPE html>
<html>
    <head>
