                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-control-sm" id="idProvMod" name="idProvMod" readonly="readonly">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-control-sm" id="nombreProvMod" name="nombreProvMod" required="required">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="number" step="any" class="form-control form-control-sm" id="telProvMod" name="telProvMod" required="required">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
