<%-- 
    ...
    Created on : 2/02/2019, 08:03:09 PM
        ...
        <div class="container"<!-- INICIO DE SECCION PRINCIPAL -->
            <div class="div-interno-centrado">
                <div class="form-centrado">
                    <form class="form-control" method="POST" autocomplete="off" action="../BuscarEmpleado">
                        <table>
                            <tbody>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="number" step="any" class="form-control form-control-sm" id="idEmpBuscar" name="idEmpBuscar" required="required">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
