...
<%
    ...
    ArrayList lista = c.consulta("proveedor.nombre,proveedor.telefono,proveedor.id", "proveedor",
            "proveedor.id is not null AND estado != 10 LIMIT 50", 3);
%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body onload="regreso();">
        ...
        <div class="container"><!-- INICIO DE SECCION PRINCIPAL -->
                <form class="form-control" method="POST" autocomplete="off" action="../BuscarProveedor">
                    <table style="width: 100%;">
                        <tr>
                            <td>
                                <input class="form-control form-control-sm" type="number" step="any" id="provBuscada" name="provBuscada" autocomplete="off">
                            </td>
                            <td>
                                <input class="btn btn-success" type="submit" id="buscarProv" name="buscarProv" value="Buscar">
                            </td>
                        </tr>
                    </table>
                </form>
            <scroll-container>
                <table class="tabla">
                    <tr>
                        ...
                        <td style="text-align: center;"><b>Tel&eacute;fono</b></td>
                    ...
                    <tr>
                        ...
                        %>
                                    <td>
                                        <center>
                                            <form autocomplete="off" method="POST" action="../EliminarProveedor">
                                                <input type="text" id="idProvEliB" name="idProvEliB" value="<%= lista.get(i-1) %>" hidden="true">
                                    ...
                                    <td>
                                        <center>
                                            <form autocomplete="off" method="POST" action="../ModificarProveedor">
                                                <input type="text" id="idProvModB" name="idProvModB" value="<%= lista.get(i-1) %>" hidden="true">
