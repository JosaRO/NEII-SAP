<%-- 
    Document   : GestionarContratacion
    Created on : 22/04/2019, 03:38:26 PM
...
<%
    ...
    ArrayList lista = c.consulta("cliente.nombre,servicio.nombre,contratacion_servicio.id", "servicio,cliente,contratacion_servicio",
            "cliente.id = contratacion_servicio.cliente AND servicio.id = contratacion_servicio.servicio LIMIT 20", 3);
%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body onload="regreso();">
        ...
        <div class="container"><!-- INICIO DE SECCION PRINCIPAL -->
                <form class="form-control" method="POST" autocomplete="off" action="../BuscarContratacion">
                    <table style="width: 100%;">
                        <tr>
                            <td>
                                <input class="form-control form-control-sm" type="number" step="any" id="contBuscada" name="contBuscada" autocomplete="off">
                            </td>
                            <td>
                ...
                <table class="tabla">
                    ...
                    <tr>
                        ...
                        %>
                                    ...
                                    <td>
                                    <center>
                                        <form autocomplete="off" method="POST" action="../ModificarContratacion">
                                            <input type="text" id="idContMod" name="idContMod" value="<%= lista.get(i-1) %>" hidden="true">
